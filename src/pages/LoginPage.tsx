...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-dvh w-full min-w-0 flex-col bg-[#F4F0EA] text-gray-900">
      ...
      <main className="alveo-px-screen mx-auto flex w-full min-w-0 max-w-lg flex-1 flex-col py-8 pb-[max(2rem,calc(1rem+env(safe-area-inset-bottom,0px)))] md:justify-center md:py-12">
